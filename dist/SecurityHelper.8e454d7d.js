var $jjhNn$crypto = require("crypto");
...
$parcel$export(module.exports, "default", () => $d88ec3d95ff82516$export$2e2bcd8739ae039);
/// <reference types="node" />

class $d88ec3d95ff82516$export$2e2bcd8739ae039 {
    /**
   *
   * @param input
   ...
   */ static hash(input, algorithm = 'sha256') {
        if (!input) return;
        return (0, ($parcel$interopDefault($jjhNn$crypto))).createHash(algorithm).update(input).digest('hex');
    }
    /**
   *
   ...
   */ static generateRSAKeyPair(modulusLength = 2048) {
        const { publicKey: publicKey, privateKey: privateKey } = (0, ($parcel$interopDefault($jjhNn$crypto))).generateKeyPairSync('rsa', {
   ...
   */ static encryptText(publicKey, plainText) {
        const encryptedData = (0, ($parcel$interopDefault($jjhNn$crypto))).publicEncrypt({
            key: publicKey,
            padding: (0, ($parcel$interopDefault($jjhNn$crypto))).constants.RSA_PKCS1_OAEP_PADDING,
            oaepHash: 'sha256'
   ...
   */ static decryptText(privateKey, encryptedTextBase64) {
        const decryptedData = (0, ($parcel$interopDefault($jjhNn$crypto))).privateDecrypt({
            key: privateKey,
...
//# sourceMappingURL=SecurityHelper.8e454d7d.js.map
