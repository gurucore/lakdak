...
$parcel$export(module.exports, "default", () => $e6237b7283b6d9ae$export$2e2bcd8739ae039);
/// <reference types="node" />

class $e6237b7283b6d9ae$export$2e2bcd8739ae039 {
    /**
   * Get current server IP address
   * @param ipType "v4" or "v6"
   * @returns
   */ static getCurrentServerIpAddresses(ipType = 'v4') {
        const networkInterfaces = Object.values((0, ($parcel$interopDefault($kRbD7$os))).networkInterfaces()).reduce((r, a)=>{
            r = r.concat(a);
            return r;
...
//# sourceMappingURL=DevOpsHelper.169e49fc.js.map
